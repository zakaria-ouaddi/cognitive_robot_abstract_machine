...
from coraplex.datastructures.enums import FilterConfig
from coraplex.ros_utils.force_torque_sensor import (
    ForceTorqueSensor,
...
class ForceTorqueSensorTestCase(unittest.TestCase):
    ...
    @patch("coraplex.ros_utils.force_torque_sensor.World")
    ...
    @patch("coraplex.ros_utils.force_torque_sensor.World")
    @patch("coraplex.ros_utils.force_torque_sensor.create_publisher")
    def test_initialization_simulated_sensor_invalid_joint(
        self, mock_create_publisher, mock_world
    ):
    ...
    def test_get_last_value(self):
        ...
        sensor.whole_data = {
            sensor.filtered: [mock_data],
            sensor.unfiltered: [mock_data],
        }
    ...
    def test_get_derivative(self):
        ...
        sensor.whole_data = {
            sensor.filtered: [mock_data1, mock_data2],
            sensor.unfiltered: [mock_data1, mock_data2],
        }
