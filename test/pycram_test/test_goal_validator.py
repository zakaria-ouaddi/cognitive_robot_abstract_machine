...
class TestGoalValidator(GoalTestCase):
    ...
    def test_single_position_goal_generic(self):
        goal_validator = GoalValidator(
            PositionErrorChecker(),
            lambda: PoseStamped.from_spatial_type(
                self.world.get_body_by_name("breakfast_cereal.stl").global_pose
            ).position.to_list(),
        )
    ...
    def validate_orientation_goal(self, goal_validator):
        ...
        self.assertAlmostEqual(
            goal_validator.actual_percentage_of_goal_achieved, 1, places=5
        )
        self.assertAlmostEqual(goal_validator.current_error.tolist()[0], 0, places=5)
    ...
    def validate_revolute_joint_position_goal(
        self, goal_validator, joint_type: Optional[JointType] = None
    ):
        ...
        for percent in [0.5, 1]:
            ...
            if percent == 1:
                ...
                self.assertFalse(goal_validator.goal_achieved)
            self.assertAlmostEqual(
                goal_validator.actual_percentage_of_goal_achieved, percent, places=5
            )
            self.assertAlmostEqual(
                goal_validator.current_error.tolist()[0],
    ...
    def validate_prismatic_joint_position_goal(
        ...
        for percent, achieved_percentage in zip([0.5, 1], achieved_percentage):
            ...
            if percent == 1:
                ...
                self.assertFalse(goal_validator.goal_achieved)
            self.assertAlmostEqual(
                goal_validator.actual_percentage_of_goal_achieved,
                achieved_percentage,
                places=4,
            )
            self.assertAlmostEqual(
                goal_validator.current_error.tolist()[0], 0.2 * (1 - percent), places=3
            )
    ...
    def validate_multi_joint_goal(
        self, goal_validator, joint_types: Optional[List[JointType]] = None
    ):
        ...
        for percent, achieved_percentage in zip([0.5, 1], achieved_percentage):
            ...
            self.assertAlmostEqual(
                goal_validator.current_error.tolist()[1],
    ...
    def validate_list_of_poses_goal(self, goal_validator):
        ...
        for percent in [0.5, 1]:
            ...
            self.assertAlmostEqual(
                goal_validator.current_error.tolist()[0], 1 - percent, places=5
            )
            self.assertAlmostEqual(
                goal_validator.current_error.tolist()[1],
                np.pi * (1 - percent) / 2,
            ...
            self.assertAlmostEqual(
                goal_validator.current_error.tolist()[2], (1 - percent), places=5
            )
            self.assertAlmostEqual(
                goal_validator.current_error.tolist()[3],
                np.pi * (1 - percent) / 2,
                places=5,
            )
    ...
    def validate_list_of_positions_goal(self, goal_validator):
        ...
        for percent in [0.5, 1]:
            ...
            self.assertAlmostEqual(
                goal_validator.current_error.tolist()[1], 1 - percent, places=5
            )
    ...
    def test_list_of_revolute_joint_positions_goal(self):
        ...
        self.validate_list_of_revolute_joint_positions_goal(
            goal_validator, [JointType.REVOLUTE, JointType.REVOLUTE]
        )
