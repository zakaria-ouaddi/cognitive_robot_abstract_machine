...
Comprehensive examples are provided as Jupyter Notebooks in the `examples` folder and documented in the [Examples section](https://cram2.github.io/cognitive_robot_abstract_machine/coraplex/notebooks/language.html). Refer to the examples folder's `README` for instructions on executing these notebooks.
...
If you want to cite CoraPlex in your work, you can use the following bibtex entry:

.. code-block:: bibtex

        @software{dech2024coraplex,
        author = {Dech, Jonas and Bassiouny, Abdelrhman and  Schierenbeck, Tom and Hassouna, Vanessa and Krohm, Luca and Prüsser, David},
        title = {CoraPlex: A Python framework for cognition-enbabled robtics},
